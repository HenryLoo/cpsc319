...
urlpatterns = patterns('',
	...
	url(r'^students/(?P<student_id>\d+)/$', 
		...
		name='studentedit'),
	url(r'^students/(?P<student_id>\d+)/delete/$',
		'school_components.views.students_view.delete_student_view',
		name='delete_student'),
	...
	url(r'^courses/(?P<course_id>\d+)/delete/$',
		'school_components.views.courses_view.course_delete',
		name='coursedelete'),
	...
	url(r'^courses/assignment/(?P<course_id>\d+)/$', 
		'school_components.views.courses_view.course_assignment', 
		name='courseassignment'),
	url(r'^courses/assignment/(?P<course_id>\d+)/delete/(?P<assignment_id>\d+)$',
		'school_components.views.courses_view.course_assignment_delete',
		name='courseassignmentdelete'),
	...
	url(r'^departments/create/$', 
		...
		name='deptedit'),
		url(r'^departments/(?P<dept_id>\d+)/delete/$',
		'school_components.views.courses_view.dept_delete',
		name='deptdelete'),
	...
	url(r'^classes/create/$', 
		...
		name='classcreate'),
	url(r'^classes/(?P<class_id>\d+)/delete/$',
		'school_components.views.classes_view.class_delete',
		name='classdelete'),
    ...
    url(r'^classes/assignment/(?P<class_id>\d+)/$', 
		'school_components.views.classes_view.class_assignment', 
		name='classassignment'),
    url(r'^classes/assignment/(?P<class_id>\d+)/(?P<status>\w+)/$', 
		'school_components.views.classes_view.class_assignment', 
		name='classassignment'),
    url(r'^classes/assignment/(?P<class_id>\d+)/delete/(?P<assignment_id>\d+)$',
		'school_components.views.classes_view.class_assignment_delete',
		name='classassignmentdelete'),
    url(r'^classes/(?P<class_id>\d+)/(?P<assignment_id>\d+)/edit/$',
        'school_components.views.classes_view.assignment_edit',
        name='assignmentedit'),
    ...
    url(r'^schools/(?P<school_id>\d+)/edit/$',
        ...
        name='schooledit'),
    url(r'^schools/(?P<school_id>\d+)/delete/$',
        'school_components.views.schools_view.school_delete',
        name='schooldelete'),
    ...
    url(r'^periods/(?P<period_id>\d+)/$',
        'school_components.views.periods_view.period_list',
        name='periodlist'),
    url(r'^periods/(?P<period_id>\d+)/delete/$',
        'school_components.views.periods_view.period_delete',
        name='perioddelete'),
